...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; font-family: 'Inter', sans-serif; }
        ...
        .hero h1 { font-size: 2.5rem; font-weight: 800; color: #f1f5f9; line-height: 1.2; margin-bottom: 1rem; }
        ...
        .section-title { font-size: 1.3rem; font-weight: 700; color: #f1f5f9; }
        .section-title span { color: #a78bfa; }
        .view-all {
            color: #a78bfa; text-decoration: none; font-size: 0.85rem; font-weight: 600;
            border: 1px solid rgba(167,139,250,0.3); padding: 0.4rem 1rem; border-radius: 8px;
        ...
        .product-category {
            font-size: 0.72rem; font-weight: 600; color: #a78bfa; text-transform: uppercase;
